...
`@script`
If you want to run all the tests contained within your current directory, use the following command. However, for a test module to be found by this command, its name should contain the prefix TEST.
